...
SYSTEM = (
    ...
    "=== FIM ===\n\n"
    "=== AUTENTICIDADE (ANTI-DESMONETIZAÇÃO IA) — OBRIGATÓRIO ===\n"
    "O YouTube desmonetiza conteúdo 'inautêntico/repetitivo' (enforcement por canal e em "
    "REDE). NÃO faça resumo neutro de fonte única: TRAGA UMA TESE/ÂNGULO ORIGINAL do roteiro "
    "(uma leitura, conexão ou implicação que a fonte não diz com essas palavras), "
    "sintetizando >=2 perspectivas. Cada vídeo deve ter um ângulo DISTINTO dos anteriores do "
    ...
    "mais?'), nunca em afirmação inventada. JAMAIS deixe marcadores de preenchimento "
    "ou variáveis no texto (ex.: {nome do jogador}, {data}, {time A}, 'fulano', "
    "'X minutos') — isso quebra o vídeo; se não sabe o específico, REESCREVA a frase "
    "para não precisar dele. Conteúdo de conhecimento geral (tutoriais, "
