  ...
  return (
    <div className="card p-3 sm:p-5">
      ...
      <div className="grid grid-cols-7 gap-0.5 sm:gap-1">
        {cells.map((d, i) => (
          <div key={i} className={`min-h-[52px] sm:min-h-[68px] rounded-btn p-0.5 sm:p-1 border ${d ? 'border-border bg-elevated/40' : 'border-transparent'} ${d && d.toDateString() === today ? 'ring-1 ring-accent' : ''}`}>
